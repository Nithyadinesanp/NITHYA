...
package com.niit.giftbackend.config;
...
@Configuration
@ComponentScan(basePackages = "com.niit.giftbackend")
public class AppContext {
	...
	public DataSource getH2DataSource() {
		...
		dataSource.setUrl("jdbc:h2:tcp://localhost/~/giftmy");
	...
	public LocalSessionFactoryBean getSessionFactory(DataSource dataSource) {
		...
		sessionFactory.setPackagesToScan(new String[] {"com.niit.giftbackend.model"});
